...
<head>
    ...
    <style>
        ...
        *::after {
        ...
        .rv.sl { transform: translateX(-28px); }
        .rv.sr { transform: translateX(28px); }
        ...
        .mq-l { animation: mqL var(--d, 38s) linear infinite; }
        .mq-r { animation: mqR var(--d, 38s) linear infinite; }
        ...
        .btn-primary.lg { font-size: 17px; padding: 18px 40px; }
        ...
        @keyframes blink {
            0%, 100% { box-shadow: 0 0 0 0 rgba(255, 60, 0, .5) }
            50% { box-shadow: 0 0 0 7px rgba(255, 60, 0, 0) }
        }
        ...
        @media(hover:hover) and (pointer:fine) {
            .nav-dropdown:hover .nav-dropdown-toggle { color: var(--paper); }
        ...
        .nav-dropdown.is-open .nav-dropdown-toggle { color: var(--paper); }
        ...
        .nav-dropdown-item.on { color: var(--flame); }
        ...
        .nav-dropdown-view-all:hover { background: rgba(255, 60, 0, .08); }
        ...
        .nav-ham {
            display: none; /* hidden until tablet/mobile breakpoint */
            width: 44px;
            height: 44px;
            background: transparent;
            border: none;
        ...
        .nav-ham span {
            ...
            border-radius: 2px;
            transition: transform 0.4s var(--ease), width 0.3s cubic-bezier(0.16, 1, 0.3, 1), background 0.3s;
        }

        .nav-ham:hover span { background: var(--flame); }
        .nav-ham:hover span:first-child { width: 16px; }
        .nav-ham:hover span:last-child { width: 28px; }

        /* ── FLOATING LETS TALK (Rounded Pill) ── */
        .floating-talk-wrap {
            position: fixed;
        ...
        .floating-talk-btn {
            ...
            align-items: center;
            gap: 12px;
            background: linear-gradient(135deg, #FF5A26, var(--flame));
            color: #fff;
            font-family: var(--fDisplay);
            font-size: 14px;
            font-weight: 700;
            ...
            padding: 16px 32px;
            border-radius: 100px;
            box-shadow: 0 12px 28px rgba(255, 60, 0, 0.35), inset 0 2px 0 rgba(255, 255, 255, 0.15);
        ...
        .floating-talk-btn:hover {
            ...
            box-shadow: 0 20px 40px rgba(255, 60, 0, 0.45), inset 0 2px 0 rgba(255, 255, 255, 0.25);
        }

        .floating-talk-btn:hover::before {
            opacity: 1;
        }
        ...
        .floating-talk-btn:hover .floating-talk-icon {
        ...
        #g-menu {
            ...
            z-index: 700;
            background: var(--s1);
            clip-path: circle(0% at calc(100% - var(--px) - 22px) calc(var(--navH) / 2));
        ...
        #g-menu.open {
            clip-path: circle(170% at calc(100% - var(--px) - 22px) calc(var(--navH) / 2));
            pointer-events: all;
        }
        ...
        .menu-link.accent { color: rgba(255, 60, 0, .16); }
        .menu-link.accent:hover { color: var(--flame); }
        ...
        .menu-svc-group.is-open .nav-dropdown-arrow { transform: rotate(180deg); }
        ...
        .menu-meta-lnk:hover { color: var(--flame); }
        ...
        .foot-lnk:hover { color: var(--flame); }
        ...
        @media(max-width:767px) {
            ...
            .menu-nav { padding: var(--navH) var(--px) var(--px); }
            
            .menu-close-btn { top: 16px; }
...
<body>
    ...
    <nav id="g-nav" role="navigation" aria-label="Main navigation">
        ...
        <div class="nav-right">
            <button class="nav-ham" id="g-ham" onclick="hosMenu()" aria-label="Open menu" aria-expanded="false" aria-controls="g-menu">
                <span id="hb1"></span><span id="hb2"></span>
            </button>
        </div>
    </nav>

    <div class="floating-talk-wrap">
        <a href="<?= base_url('contact') ?>" class="floating-talk-btn">
            Let's talk
            <span class="floating-talk-icon">
    ...
    <div id="g-menu" role="dialog" aria-modal="true" aria-label="Navigation menu">
        ...
        <button class="menu-close-btn" onclick="hosMenu()" aria-label="Close menu">
            Close 
